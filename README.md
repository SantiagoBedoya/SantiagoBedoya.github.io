...
- GoodRx: Contributed to the design and maintenance of scalable data infrastructure supporting healthcare data workflows. Built and orchestrated data pipelines using Apache Airflow and Astronomer, ensuring reliable scheduling, monitoring, and execution of data processes across environments. Leveraged Amazon Redshift to support efficient data storage and analytics at scale. Developed and maintained microservices in Golang, including implementations of multi-tenancy patterns to support scalable and isolated systems. Maintained backend services in Python/Django, integrating them with PostgreSQL for robust data persistence. Collaborated on improving system reliability, data consistency, and development workflows while applying agile practices and leveraging AI-powered tools to enhance delivery speed and code quality.
...
- Disney Streaming: Contributed to the development of a scalable event analytics platform by enhancing and maintaining backend services written in Golang. Worked extensively with Kubernetes (EKS) and service mesh technologies such as Istio to support secure, observable, and resilient service-to-service communication. Implemented inter-service communication using both gRPC and HTTP, and leveraged asynchronous messaging patterns with Kafka and RabbitMQ. Participated in architectural improvements to optimize system performance, scalability, and monitoring.
- Disney Parks: Focused on maintaining and extending backend microservices that support the parks' operational platform. Worked primarily with AWS Lambda functions written in Golang, integrating them with other cloud-native components for real-time functionality. Utilized gRPC and HTTP for service communication, and contributed to the overall reliability of the system by improving observability, deployment pipelines (Jenkins, Spinnaker), and secure configuration practices using Vault. Played a key role in ensuring the seamless evolution of existing services within a distributed, event-driven architecture.
...
- Dow Jones Collaboration: Spearheaded enhancements to Single Sign-On (SSO) services, optimizing user authentication processes and bolstering security measures. Led the development of an intuitive administrative frontend using Next.js, improving user management capabilities and streamlining administrative tasks.
- SecureWorks Contribution: Played a pivotal role in the evolution of SecureWorks by leveraging Golang and Microservices architecture to develop innovative features, enhancing the platform's scalability and performance. Implemented agile methodologies to ensure rapid and efficient feature delivery.
- Nike Engagement: Contributed to the success of Nike by crafting robust APIs using Python, GraphQL, and various AWS services. Collaborated closely with cross-functional teams to meet project objectives and deliver high-quality software solutions within tight deadlines.
...
- Innovative Technological Solutions: Leveraged expertise in backend development and real-time communication technologies to develop innovative and robust solutions. Contributed to the continuous improvement of software development processes, optimizing performance and enhancing user experiences.
